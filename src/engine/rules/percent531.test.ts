...
const work = (topReps: number, completed = true): SetResult[] => [
  { weightLb: 75, reps: 5, type: 'working', completed: true },
  { weightLb: 85, reps: 5, type: 'working', completed: true },
...
describe('5/3/1', () => {
  ...
  it('W3 top set fails (0 reps) → TM resets to ~90% e1RM, deload flag', () => {
    ...
    expect(r.nextState.trainingMaxLb).toBeLessThan(100);
